...
public class CartController {
    ...
    // GET /api/cart/{userId}
    @GetMapping("/{userId}")
    public CartViewDTO getCart(@PathVariable Long userId) {
    ...
    @PostMapping("/items")
    public CartViewDTO addToCart(@RequestParam Long userId,
    ...
    public CartViewDTO updateItem(@PathVariable Long cartItemId,
                                  @RequestParam Integer quantity) {
    ...
    public CartViewDTO removeItem(@PathVariable Long cartItemId) {
    ...
    private CartItemViewDTO toItemView(CartItem item) {
        ...
        dto.setQuantityPrice(item.getQuantityPrice()); // FE đọc quantityPrice
